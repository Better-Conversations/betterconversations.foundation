...
const pathToFileMap = {
  ...
  '/approach/courses': 'src/pages/approach/courses.astro',
  ...
  '/partner/deliver-courses': 'src/pages/partner/deliver-courses.astro',
  '/partner/organizations': 'src/pages/partner/organizations.astro',
